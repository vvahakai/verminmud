...
public class DwarfRace extends PlayerRace {
	private static HumanHand hand = null;
	
	protected static DwarfRace _instance = null;

	private String name = new String("dwarf");
   ...
   public Slot[] getSlots()
   {
	...
	{
		return (Race) World.get("races/dwarf");
	}
	...
	public int getMaxMentalStrength() { return 25; }
	public int getMaxPhysicalConstitution() { return 70; }
	public int getMaxMentalConstitution() { return 20; }
	public int getMaxPhysicalCharisma() { return 50; }
	public int getMaxMentalCharisma() { return 30; }
	...
	public int getMentalStrengthCost() { return 7; }
