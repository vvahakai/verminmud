...
import static org.vermin.mudlib.battle.GoreProperty.IS_FLYING;
...
public class FlyingInsectoidRace extends DefaultRaceImpl implements Singleton {

	
	protected static FlyingInsectoidRace _instance = null;

	private String name = new String("insect");
	private int size = 10;
	...
	public String getHitLocation(int pos)
	{
		...
		if(pos < 32)	{ return "front body section"; }
		if(pos < 60)	{ return "middle body section"; }
		if(pos < 67)	{ return "left wing"; }
	...
	public EnumSet<GoreProperty> getGoreFlags() {
		return EnumSet.of(HAS_EXOSKELETON, HAS_INTERNAL_ORGANS, IS_INSECT, IS_FLYING);
	}
	...
	{
		if(_instance == null) {
			_instance = new FlyingInsectoidRace();
			_instance.start();
		}
