...
public class UnlockCommand extends TokenizedCommand {
				...
				while(items.hasNext()) {
					...
					if(item instanceof Key) {
						...
						if(key.getKeyCode().equals(ld.getKeyCode())) {
							...
							properKey = true;
							ld.setLocked(false);
							who.notice("You unlock the door with "+key.getDescription()+".");
							break;
						} 
					}
				}
