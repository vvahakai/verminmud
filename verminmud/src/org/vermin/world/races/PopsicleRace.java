...
import org.vermin.world.items.MonsterBody;

public class PopsicleRace extends DefaultRaceImpl implements Singleton {
	protected static PopsicleRace _instance = null;

	private String name = new String("popsicle");
	private int size = 45;
	...
	{
		if(pos < 65)	{ return "body"; }
		if(pos <= 100)	{ return "stick"; }
