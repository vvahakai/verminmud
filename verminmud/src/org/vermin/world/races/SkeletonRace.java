...
public class SkeletonRace extends DefaultRaceImpl implements Singleton {
	protected static SkeletonRace _instance = null;
	...
	protected SkeletonRace() {
		goreFlags = EnumSet.of(GoreProperty.HAS_BONES, GoreProperty.IS_MAGICAL, GoreProperty.IS_UNDEAD);
