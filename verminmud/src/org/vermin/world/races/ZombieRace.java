...
public class ZombieRace extends DefaultRaceImpl implements Singleton {
	protected static ZombieRace _instance = null;
	...
	protected ZombieRace() {
		goreFlags = EnumSet.of(GoreProperty.HAS_BONES, GoreProperty.IS_MAGICAL, GoreProperty.IS_UNDEAD, GoreProperty.HAS_BLOOD, GoreProperty.HAS_INTERNAL_ORGANS);
